...
class Income_groups_cash_in_otc extends Admin_Controller {
	...
	public function new() {
		...
		$base_form_url				= base_url() . "income-groups-cash-in-otc/new";
		...
		$this->_data['title']  	= "Cash In (OTC) - New Group Member";
	...
	public function update($group_id) {
		...
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-groups-cash-in-otc/update/{$group_id}";
		...
		$this->_data['listing'] = $this->table_listing('', $results, count($results));
		$this->_data['title']  	= "Cash In (OTC) - Update Group";
		$this->set_template("income_groups/form", $this->_data);
	}

	public function delete($group_id) {
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-groups-cash-in-otc/delete/{$group_id}";
		...
		if ($_POST) {
			...
			if ($confirmation == "DELETE") {
				...
				redirect(base_url() . "income-groups-cash-in-otc");
			}
		}

		$this->_data['title']  	= "Cash In (OTC) - DELETE GROUP - ID: {$group_id}";
