...
class Disapproval_reason_types_model extends CI_Model {
	private 
		$_table	= 'disapproval_reason_types  disapproval_reason_types',
		$_table_x	= 'disapproval_reason_types';

	private
		$_id = "	disapproval_reason_type_id";
