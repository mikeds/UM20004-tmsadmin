...
class Income_groups_scanpayqr extends Admin_Controller {
	private
	...
	public function new() {
		...
		$base_form_url				= base_url() . "income-groups-scanpayqr/new";
		...
		$this->_data['title']  	= "ScanPayQR - New Group Member";
	...
	public function update($group_id) {
		...
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-groups-scanpayqr/update/{$group_id}";
		...
		$this->_data['listing'] = $this->table_listing('', $results, count($results));
		$this->_data['title']  	= "ScanPayQR - Update Group";
		$this->set_template("income_groups/form", $this->_data);
	}

	public function delete($group_id) {
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-groups-scanpayqr/delete/{$group_id}";
		...
		if ($_POST) {
			...
			if ($confirmation == "DELETE") {
				...
				redirect(base_url() . "income-groups-scanpayqr");
			}
		}

		$this->_data['title']  	= "ScanPayQR - DELETE GROUP - ID: {$group_id}";
