...
class Income_shares_cash_out_ubp extends Admin_Controller {
	private
	...
	public function index($page = 1) {
		...
		$this->_data['title']  = "Cash Out (UBP) - Income Shares";
		$this->set_template("income_shares/list", $this->_data);
	}

	public function update($group_id) {
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-shares-cash-out-ubp/update/{$group_id}";
		...
		$this->_data['title']  	= "Cash Out (UBP) - Income Shares - Update";
