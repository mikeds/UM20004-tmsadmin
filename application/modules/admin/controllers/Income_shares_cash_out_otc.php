...
class Income_shares_cash_out_otc extends Admin_Controller {
	private
		$_admin_account_data = NULL,
		$_transaction_type_id = "cash_out_otc";
	...
	public function index($page = 1) {
		...
		$this->_data['title']  = "Cash Out (OTC) - Income Shares";
		$this->set_template("income_shares/list", $this->_data);
	}

	public function update($group_id) {
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-shares-cash-out-otc/update/{$group_id}";
		...
		$this->_data['title']  	= "Cash Out (OTC) - Income Shares - Update";
