...
class Income_shares_quickpayqr extends Admin_Controller {
	private
	...
	public function index($page = 1) {
		...
		$this->_data['title']  = "QuickPayQR - Income Shares";
		$this->set_template("income_shares/list", $this->_data);
	}

	public function update($group_id) {
		$this->_data['notification'] 	= $this->session->flashdata('notification');
		$this->_data['form_url']		= base_url() . "income-shares-quickpayqr/update/{$group_id}";
		...
		$this->_data['title']  	= "QuickPayQR - Income Shares - Update";
